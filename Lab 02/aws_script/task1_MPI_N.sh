...
if [ "$#" -eq 0 ]; then
    ...
    echo "Usage: bash script/task1_MPI_N.sh <proc_count1> [proc_count2 ...]"
    echo "Example: bash script/task1_MPI_N.sh 2 4 8 16"
    exit 1
fi
...
echo "Starting Open MPI Benchmark for N scaling..."
